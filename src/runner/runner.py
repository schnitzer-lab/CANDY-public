...
from src.runner.utils import init_model, init_dataloader, init_csv
...
def runner(data_path_lst, params):
    ...
    try:
        ...
        data_dict, obs_dim_lst = init_dataloader(train_dataset, valid_dataset, test_dataset, dataset_info, **params)
