...
from src.data_loader.dataloader_monkey import dataloader_perich, dataloader_perich_particular_direction
...
def runnerN(data_path_lst, params):
    ...
    try:
        ...
        if ckpt_num is not None:
            ...
            if model_type.lower() == 'shareddfine':
                ...
                model._load_ckpt(model.dfine_list, model.mapper, model.optimizer)
