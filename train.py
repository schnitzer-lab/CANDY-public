...
def main(args):
    ...
    df_train, df_test = runner(data_path_lst, params)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_config',type=str, default='config/model_config/candy_cbatch64_ctemp0.2_cs0.1_cts0.yaml',
